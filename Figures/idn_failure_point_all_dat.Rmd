...
```{r raw_combined, fig.width=5, fig.height=3}
ss_dat_c%>%
  ...
  labs(x= TeX("Strain $\\epsilon$"),
       ...
       title = "a) AS Stress-Strain Curves")+
...
dat_pred%>%
  ...
  labs(x= TeX("Scaled Strain ($\\epsilon^{*}$)"),
       y = TeX("Stress $\\sigma$ (GPa)"),
       title = "b) Stress-Strain Curves and Functional Fit")+
  theme(legend.position = "bottom",
        axis.text = element_text(size = 7),
        strip.text.x = element_text(size= 6))
```
...
dat_pred%>%
  ...
  labs(x= TeX("Scaled Strain ($\\epsilon^{*}$)"),
       y = TeX("Stress $\\sigma$ (GPa)"),
       title = "c) Functional Prediction at End-of-Test")+
  theme(legend.position = "bottom",
        axis.text = element_text(size = 7),
        strip.text.x = element_text(size= 6))
```
