...
eps_global <- 1e-20 #1e-10, -20 for specially hard cases
max_train_iters <- 10
scale_vars <- "after"
al_steps <- 6
exp_name <- "train_bin_rl_low_rank_prior_gam_pol_m52_2026_09_21"
only_int <- F
ini_seed <- 233545
np_seed <- 12143
verbose <- F
...
cor_fun_test <- function(theta, D_mat) general_cor_fun(theta = theta,
                                                       D_mat = D_mat,
                                                       kernel_fun = matern_5_2_fun) #matern_5_2_fun gaus_ker_fun
```
...
for(iter in 0:5){
  ...
  if(file.exists(file_path)){
    ...
    mod_hom_c <- fit_mvgp_sv_fun(Y = Y_train_c,
                            ...
                            cov_bp = sig_type,
                            n_rank = ini_hom_c$n_rank,
                            n_rank_pars = ini_hom_c$n_rank_pars,
                            joint_cov = joint_cov,
                            het_sv = F,
                            lb = ini_hom_c$lb,
                            ub = ini_hom_c$ub,
    ...
    mod_hom_t <- fit_mvgp_sv_fun(Y = Y_train_t,
                            ...
                            joint_cov = joint_cov,
                            cov_bp = sig_type,
                            n_rank = ini_hom_t$n_rank,
                            n_rank_pars = ini_hom_t$n_rank_pars,
                            het_sv = F,
                            lb = ini_hom_t$lb,
                            ub = ini_hom_t$ub,
    ...
    if(iter >0){
      ...
      ini_sol_t <- pars_hom_to_het_reg(mod_hom_t$opt_sol$solution,
                               ...
                               X = X_train_ilr,
                               cov_bp = sig_type,
                               n_rank = mod_hom_t$n_rank,
                               n_rank_pars = mod_hom_t$n_rank_pars,
    ...
    mod_t <- fit_mvgp_sv_fun(Y = Y_train_t,
                        ...
                        cor_fun = cor_fun_test,
                        cov_bp = sig_type,
                        n_rank = ini_sol_t$n_rank,
                        n_rank_pars = ini_sol_t$n_rank_pars,
                        joint_cov = joint_cov,
                        het_sv = T,
    ...
    if(iter>0){
      ...
      ini_sol_c <- pars_hom_to_het_reg(mod_hom_c$opt_sol$solution,
                           ...
                           X = X_train_ilr,
                           cov_bp = sig_type,
                           n_rank = mod_hom_c$n_rank,
                           n_rank_pars = mod_hom_c$n_rank_pars,
                           edge_locs = pX_edge_ilr,
    ...
    mod_c <- fit_mvgp_sv_fun(Y = Y_train_c,
                            ...
                            a_mult_px =am_px,
                            cov_bp = sig_type,
                            n_rank = ini_sol_c$n_rank,
                            n_rank_pars = ini_sol_c$n_rank_pars,
                            n_edge = n_ed,
                            cor_fun = cor_fun_test,
                            joint_cov = joint_cov,
                            het_sv = T,
  ...
  save(np_id_h,
     file = here::here("Results","Fixed Data",
                       "ALV2_26_9_prior_gam_np_h_low_rank_pol_m52.RData"))
