...
scale_vars <- "after"
al_steps <- 6
exp_name <- "train_bin_rl_prior_gam_pol_gaus_2026_05_19"
only_int <- F
ini_seed <- 233545
np_seed <- 12143
verbose <- F
...
n_order <- 3
ini_prev_mod <- T
cov_type = "Gaussian" #"Gaussian", "Matern5_2", "Matern3_2"


cor_fun_test <- function(theta, D_mat) general_cor_fun(theta = theta,
                                                       D_mat = D_mat,
                                                       kernel_fun = gaus_ker_fun) #matern_5_2_fun gaus_ker_fun
```
...
save(np_id_h,
     file = here::here("Results","Fixed Data",
                       "ALV2_26_prior_gam_np_h_pol_gaus.RData"))
