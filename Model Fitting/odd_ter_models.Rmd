...
scale_vars <- "after"
al_steps <- 6
exp_name <- "train_binodd_mat32_25-04-25"
ini_seed <- 233545
np_seed <- 12143
verbose <- F
pen_par <- F
...
Basis_X <- create_mv_basis_fun(as.matrix(dat_ss_train[,metals]),
                                   n_out = n_prop,
                               type = "bs",
                                   prop_names = prop_b,
                                    knots_list = knot_list,
                                   sparse_mat = T,
                               func_intercept = F,
                               omit_last_var = T,
                                   var_names = metals)
  
Basis_X_all <- create_mv_basis_fun(as.matrix(dat_train_B[,metals]),
                                   n_out = n_prop,
                                   type = "bs",
                                   func_intercept = F,
                                   prop_names = prop_b,
...
set.seed(ini_seed)
  ...
  file_name <- paste0(exp_name,"_models_all",".RData")
